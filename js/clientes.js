// ═══════════════════════════════════════════
// 📌 ABA: CLIENTES
// Toda lógica EXCLUSIVA de Clientes
// CRUD com modais
// ═══════════════════════════════════════════

/**
 * IDs esperados no HTML (dentro de #aba-clientes + modais globais):
...
// ========== MÁSCARAS ==========
function clientes_aplicarMascaras() {
    ...
    if (cpfCnpjInput && typeof formatCPFCNPJ === 'function') {
        cpfCnpjInput.addEventListener('input', function () { this.value = formatCPFCNPJ(this.value); });
    }
}
